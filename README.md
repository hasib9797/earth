...
<p class="ml-4">
1. Earth: The Multipurpose Discord bot and all it's versions 
</p>
...
<p class="ml-4">
Discord data is stored to make sure Earth can operate and allow servers to set their own settings.<br>
</p>
<p class="font-semibold text-gray-200 mt-4">2. Opt-in</p>
<div class="ml-4">
<p>• Any per-server settings you might have changed</p>
<p class="ml-4">
These are only saved if you change the default settings of Earth in your server and
are needed to make sure the settings you set persist over your period of time using Earth within
your server.
</p>
</div>
</div>
...
<p class="ml-4">
The following data is deleted automatically when you remove Earth from you server or stop using the bot.
</p>
<p class="ml-8 mt-2">
• Discord Server IDs<br>
• Discord Channel IDs<br>
...
<p class="ml-4">
You can contact us by sending an email to help@earthbot.pro or join our support server and dm any of the Staffs or Developers
</p>
</div>
</div>
